...
class UserApi extends Api{
     ...
     */
    public function register($username, $password, $email, $mobile = '',$id_card,$birthday,$province,$city,$county,$address,$company,$reserve_phone,$landline,$qq){
        return $this->model->register($username, $password, $email, $mobile,$id_card,$birthday,$province,$city,$county,$address,$company,$reserve_phone,$landline,$qq);
    }
